...
public class AnalyticServiceImpl implements AnalyticService {
    ...
    public CategorySpendingResult generateCategorySpendingReport(CategorySpendingCommand command) {
        ...
        accountService
            .fetchAccount(new FetchAccountCommand(command.userSid(), command.accountSid()))
            .validateUserPermission(command.userSid(), MembershipRole::canRequestReport, "request category spending report");
        ...
        final List<CategoryAggregateProjection> projections = transactionService.generateCategoryAggregates(aggregateCommand);
