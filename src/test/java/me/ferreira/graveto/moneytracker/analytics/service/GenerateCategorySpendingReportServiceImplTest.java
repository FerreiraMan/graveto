...
public class GenerateCategorySpendingReportServiceImplTest {
    ...
    void shouldMapFlatProjectionsToInfiniteDepthCategoryTree() {
        ...
        final GenerateCategoryAggregateCommand aggregateCommand = new GenerateCategoryAggregateCommand(year, account.getSid());
    ...
    private record MockCategoryProjection(int month, UUID categorySid, BigDecimal amount) implements CategoryAggregateProjection {
        @Override public int getMonth() { return month; }
        @Override public UUID getCategorySid() { return categorySid; }
