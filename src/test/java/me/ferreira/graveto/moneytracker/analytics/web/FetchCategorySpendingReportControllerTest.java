...
public class FetchCategorySpendingReportControllerTest {
  ...
  void shouldReturnCategorySpendingReportAndMapToResponseDto() {
    ...
    final ArgumentCaptor<CategorySpendingCommand> commandCaptor =
        ArgumentCaptor.forClass(CategorySpendingCommand.class);
    ...
    assertThat(testResult).bodyJson()
        .extractingPath("$.categories[0].childCategories[0].categorySid").asString()
        .isEqualTo(childCategorySid.toString());
    assertThat(testResult).bodyJson()
