...
public class FindAllTransactionsControllerTest {
    ...
    void shouldReturnPaginatedTransactionsAndMapToResponseDTO() {
        ...
        final ArgumentCaptor<FindAllTransactionsCommand> commandCaptor = ArgumentCaptor.forClass(FindAllTransactionsCommand.class);
    ...
    void shouldApplyDefaultPaginationAndSortingWhenNotProvided() {
        ...
        assertThat(capturedCommand.pageable().getSort().getOrderFor(Transaction_.OCCURRED_AT).getDirection()).isEqualTo(Sort.Direction.DESC);
    }
