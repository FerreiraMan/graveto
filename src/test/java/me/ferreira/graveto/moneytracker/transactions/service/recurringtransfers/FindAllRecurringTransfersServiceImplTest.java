...
public class FindAllRecurringTransfersServiceImplTest {
  ...
  @Test
  void shouldThrowWhenUserDoesNotHavePermissionToFindAllRecurringTransfers() {
    // Arrange
    ...
    // Act & Assert
    assertThatThrownBy(() -> recurringTransferService.fetchAllRecurringTransfers(
        new FindAllRecurringTransfersCommand(userSid, accountSid, UUID.randomUUID(),
            RecurringOperationStatus.CANCELED)))
