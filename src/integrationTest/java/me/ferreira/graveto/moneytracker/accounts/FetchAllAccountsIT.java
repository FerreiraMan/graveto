...
public class FetchAllAccountsIT extends BaseIntegrationTest {
    ...
    void shouldReturnAllAccountsOfGivenUser() {
        ...
        final Account savedAccount2 = accountRepository.save(AccountTestFactory.createAccountWithOwner(userSid, institution2, balance2));
