...
public class UpdateTransferIT extends BaseIntegrationTest {
    ...
    void shouldUpdateTransferTransactionsAndAccountBalances() {
        ...
        final Transaction updatedOutTx = updatedTransactions.stream().filter(t -> t.getType() == TransactionType.TRANSFER_OUT).findFirst().get();
        final Transaction updatedInTx = updatedTransactions.stream().filter(t -> t.getType() == TransactionType.TRANSFER_IN).findFirst().get();
        ...
        assertThat(updatedOutTx.getOccurredAt().truncatedTo(ChronoUnit.MILLIS)).isEqualTo(newOccurredAt.truncatedTo(ChronoUnit.MILLIS));
        ...
        assertThat(updatedInTx.getOccurredAt().truncatedTo(ChronoUnit.MILLIS)).isEqualTo(newOccurredAt.truncatedTo(ChronoUnit.MILLIS));
