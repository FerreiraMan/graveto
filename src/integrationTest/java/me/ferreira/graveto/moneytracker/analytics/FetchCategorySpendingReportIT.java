...
public class FetchCategorySpendingReportIT extends BaseIntegrationTest {
    ...
    void shouldFetchCategorySpendingReportWithAccurateInfiniteDepthAggregations() {
        ...
        // Level 3 tx
        final Transaction txJanElectricity = TransactionTestFactory.createTransaction(account, electricity, TransactionType.EXPENSE,
                BigDecimal.valueOf(50), TransactionStatus.ACTIVE, LocalDate.of(targetYear, 1, 10));

        // Level 2 tx
        final Transaction txJanUtilities = TransactionTestFactory.createTransaction(account, utilities, TransactionType.EXPENSE,
        ...
        final Transaction txDeleted = TransactionTestFactory.createTransaction(account, electricity, TransactionType.EXPENSE,
                BigDecimal.valueOf(9999), TransactionStatus.DELETED, LocalDate.of(targetYear, 1, 12));

        // Wrong year - should be ignored
        final Transaction txWrongYear = TransactionTestFactory.createTransaction(account, utilities, TransactionType.EXPENSE,
